...
const injectStyles = () => {
  ...
  el.innerHTML = `
    @import url('https://fonts.googleapis.com/css2?family=Syne:wght@400;600;700;100&family=Outfit:wght@300;400;500;600&display=swap');
...
const C = {
  ...
  h2: {
    fontFamily: "'Syne', sans-serif", fontWeight: 100,
      ...
      <nav style={nav}>
        ...
        <div onClick={() => { go("home"); setOpen(false); }}
          ...
          <div style={{
            ...
            fontFamily: "'Syne',sans-serif", fontWeight: 100, fontSize: "1rem", color: "var(--navy)",
          }}>N</div>
            ...
            <div>
              ...
              <div style={{ display: "flex", gap: "2rem", flexWrap: "wrap" }}>
                {[{ n: "200+", l: "Engineers" }, { n: "6", l: "Offices" }, { n: "97%", l: "Retention" }].map((s, i) => (
                  <div key={i}>
                    <div style={{ fontFamily: "'Syne',sans-serif", fontWeight: 100, fontSize: "2rem", color: "var(--cyan)" }}>{s.n}</div>
    ...
    <div onMouseEnter={() => sh(true)} onMouseLeave={() => sh(false)}
      ...
      <div style={{
        ...
        <div style={{
          ...
          background: "linear-gradient(135deg, var(--blue2), var(--cyan))",
          display: "flex", alignItems: "center", justifyContent: "center",
          fontFamily: "'Syne',sans-serif", fontWeight: 100, fontSize: "1.4rem",
          color: "var(--navy)",
        }}>{m.init}</div>
        <div style={{
          position: "absolute", inset: 0,
          ...
          <div>
            <div style={{ display: "flex", alignItems: "center", gap: "0.6rem", marginBottom: "1rem" }}>
              <div style={{
                ...
                background: "linear-gradient(135deg, var(--blue2), var(--cyan))",
                display: "flex", alignItems: "center", justifyContent: "center",
                fontFamily: "'Syne',sans-serif", fontWeight: 100, fontSize: "0.9rem", color: "var(--navy)",
              }}>N</div>
