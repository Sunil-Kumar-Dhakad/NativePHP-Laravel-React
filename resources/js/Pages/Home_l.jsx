...
const injectStyles = () => {
  ...
  el.innerHTML = `
    ...
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    /* Ensure content never hides under fixed navbar on any screen size */
    @media (max-width: 480px) {
      .nexcorp-page { padding-top: 60px !important; }
    }
  `;
...
function HomePage({ go }) {
  ...
  return (
    <div className="nexcorp-page" style={{ paddingTop: 68 }}>
      {/* ── HERO ── */}
      <section style={{
        minHeight: "calc(100vh - 68px)", display: "flex", alignItems: "center",
        position: "relative", overflow: "hidden", padding: "4rem 0 5rem",
      }}>
        {/* BG mesh */}
